...
async function buscarDocumentosNecessarios(categoria: string): Promise<DocRequisito[]> {
  try {
    ...
    const documentosFixos = ["Codigo de Ética e Conduta", "Questionario de Fornecedor", "Alvara de Funcionamento"]
    ...
    const documentosFixosFormatados = documentosFixos.map((doc, index) => ({
      ...
      titulo: doc,
      obrigatorio: true,
      descricao: "Documento obrigatorio",
    }))
    ...
    return [
      {
        id: "doc-fixo-0",
        titulo: "Codigo de Ética e Conduta",
        obrigatorio: true,
        descricao: "Documento obrigatorio",
      },
      {
        id: "doc-fixo-1",
        titulo: "Questionario de Fornecedor",
        obrigatorio: true,
        descricao: "Documento obrigatorio",
      },
      {
    ...
    >
      ...
      <section className="pt-32 pb-16 px-8 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Consulte suas notas IQF e de homologacao, envie documentos e acompanhe seu status em tempo real.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-semibold">Suas informacoes</h2>
                  <p className={clsx("text-sm", textSoft)}>Carregadas automaticamente apos o login</p>
                </div>
              </div>
              ...
              {loadingResumo ? (
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center gap-2 text-sm opacity-75">
                    ...
                    <span>{resumo.telefone ?? "Nao informado"}</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm opacity-75">
            ...
            {resumo && (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  >
                    <p className="text-xs font-semibold uppercase tracking-[0.05em] opacity-70 text-center mb-2">
                      Media IQF
                    </p>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <span className="text-xs uppercase tracking-[0.05em] opacity-70 font-semibold">
                            {item.titulo}
                          </span>
            ...
            >
              ...
              <div className="space-y-3 mb-6">
                <label
                  ...
                  className={clsx("text-xs uppercase tracking-[0.05em] font-medium", textSoft)}
                >
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    ...
                    >
                      ...
                      <span className="relative z-10">Codigo de Ética e Conduta</span>
                    </a>
                    ...
                    >
                      <Download className="w-4 h-4 relative z-10" />
                      <span className="relative z-10">Questionario de Qualificacao</span>
                    </a>
                    <a
                      href="/docs/DECLARAÇAO PARA PARCEIROS - BAIXO RISCO.pdf"
                      target="_blank"
                      className={clsx(
                        "group relative overflow-hidden flex items-center justify-center gap-2 text-white px-4 py-2 rounded-xl text-[13px] font-semibold transition-all duration-300 hover:-translate-y-1 hover:shadow-xl",
                        getGradientClasses(),
                    ...
                    <a
                      href="/docs/DECLARAÇAO PARA PARCEIROS - ALTO RISCO (2).pdf"
                      target="_blank"
                      className={clsx(
                        "group relative overflow-hidden flex items-center justify-center gap-2 text-white px-4 py-2 rounded-xl text-[13px] font-semibold transition-all duration-300 hover:-translate-y-1 hover:shadow-xl",
                        getGradientClasses(),
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-2 mb-1">
                            ...
                            {doc.obrigatorio && (
                              <span className="text-[10px] font-semibold uppercase tracking-[0.05em] rounded-full border px-2 py-0.5 bg-red-500/10 text-red-500 border-red-200/60">
                                Obrig.
                              </span>
                            )}
                          </div>
          ...
          {resumo && showHistorico && (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-semibold">Historico de Envios</h2>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[100] flex items-center justify-center p-4 overflow-y-auto">
          <div className="w-full max-w-4xl my-8">
            <div
              id="cfe-certificate"
              className={clsx(
                "relative mx-auto w-full overflow-hidden rounded-[24px] border border-orange-300 bg-white text-slate-900",
                "shadow-[0_24px_70px_rgba(15,23,42,0.18)] transition-all duration-300 animate-fade-in-up",
              )}
              style={{ aspectRatio: "297 / 200" }}
            >
              <div className="absolute inset-0 pointer-events-none">
                <div className="absolute inset-x-0 top-0 h-2 bg-gradient-to-r from-orange-500 via-red-500 to-orange-400"></div>
                <img
                  src="/logo-marca.png"
                  alt="Marca dagua Engeman"
                  className="absolute left-1/2 top-1/2 w-[460px] -translate-x-1/2 -translate-y-1/2 opacity-[0.05]"
                />
              </div>

              <div className="relative z-10 flex h-full flex-col bg-white/96 px-6 py-6 backdrop-blur-sm">
                <header className="flex flex-col gap-6 border-b border-slate-200 pb-4 md:flex-row md:items-start md:justify-between">
                  <div className="flex items-start gap-4">
                    <div className="rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm">
                      <Image src="colorida.png" alt="Engeman" width={120} height={36} className="object-contain" />
                    </div>
                    <div className="space-y-2">
                      <p className="text-[10px] uppercase tracking-[0.2em] text-slate-500">CFE</p>
                      <h1 className="text-[24px] font-semibold text-slate-900 leading-tight">Certificado de Fornecedor Engeman</h1>
                    </div>
                  </div>

                  <div className="grid grid-cols-2 gap-2 text-[12px] text-slate-600 w-full max-w-sm">
                    <div className="rounded-lg border border-slate-200 bg-white px-3 py-2">
                      <span className="text-[10px] font-semibold uppercase tracking-[0.15em] text-orange-600">Número</span>
                      <p className="mt-1 text-sm font-semibold text-slate-900">{certificateNumber}</p>
                    </div>
                    <div className="rounded-lg border border-slate-200 bg-white px-3 py-2">
                      <span className="text-[10px] font-semibold uppercase tracking-[0.15em] text-orange-600">Emissão</span>
                      <p className="mt-1 text-sm font-semibold text-slate-900">{formatDate(emissaoCertificado)}</p>
                    </div>
                    <div className="rounded-lg border border-slate-200 bg-white px-3 py-2">
                      <span className="text-[10px] font-semibold uppercase tracking-[0.15em] text-orange-600">Validade</span>
                      <p className="mt-1 text-sm font-semibold text-slate-900">{formatDate(validadeCertificado)}</p>
                    </div>
                    <div className="rounded-lg border border-slate-200 bg-white px-3 py-2">
                      <span className="text-[10px] font-semibold uppercase tracking-[0.15em] text-orange-600">Situação</span>
                      <p className="mt-1 text-sm font-semibold text-slate-900">{resumo.statusLegivel}</p>
                    </div>
                  </div>
                </header>

                <section className="mt-5 flex flex-1 flex-col gap-5">
                  <div className="rounded-2xl border border-slate-200 bg-white/95 p-5 shadow-sm space-y-4">
                    <p className="text-[13px] font-semibold uppercase tracking-[0.18em] text-orange-600 text-center md:text-left">
                      Homologação Engeman
                    </p>
                    <p className="text-[15px] leading-relaxed text-slate-700 text-center md:text-left">
                      Certificamos que a empresa <span className="font-bold text-slate-900">{resumo.nome}</span>, inscrita no CNPJ{" "}
                      <span className="font-bold text-slate-900">{resumo.cnpj}</span>, encontra-se homologada no Cadastro de Fornecedores
                      Engeman e esta autorizada a prestar serviços ou fornecer materiais conforme avaliação vigente.
                    </p>

                    {categoriasEnviadas.length > 0 ? (
                      <div className="rounded-xl border border-slate-200 bg-white/90 px-4 py-3">
                        <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-orange-600 text-center mb-3">
                        ...
                        <div className="flex flex-wrap justify-center gap-1.5">
                          {categoriasEnviadas.map((cat, idx) => (
                            <span
                              key={idx}
                              className="inline-flex items-center rounded-full border border-slate-300 bg-slate-50 px-3 py-1 text-[11px] font-medium text-slate-700"
                            >
                              {cat}
                            </span>
                          ))}
                      ...
                      <p className="rounded-xl border border-dashed border-slate-300 bg-slate-50 px-4 py-3 text-center text-[12px] text-slate-500">
                        Aguardando envio de documentação complementar para homologação de categorias específicas.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-3">
                    <div className="rounded-xl border border-slate-200 bg-white px-4 py-4 text-center shadow-sm">
                      <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-orange-600">IQF</p>
                      <p className="mt-2 text-2xl font-bold text-slate-900">{fmt(resumo.mediaIQF)}%</p>
                      <p className="mt-1 text-[11px] text-slate-600">Indice de Qualificação do Fornecedor</p>
                    </div>
                    <div className="rounded-xl border border-slate-200 bg-white px-4 py-4 text-center shadow-sm">
                      <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-orange-600">Homologação</p>
                      <p className="mt-2 text-2xl font-bold text-slate-900">{fmt(resumo.mediaHomologacao)}%</p>
                      <p className="mt-1 text-[11px] text-slate-600">Média de avaliação aos critérios Engeman</p>
                    </div>
                    <div className="rounded-xl border border-slate-200 bg-white px-4 py-4 text-center shadow-sm">
                      <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-orange-600">Proxima avaliação</p>
                      <p className="mt-2 text-xl font-bold text-slate-900">{formatDate(resumo.proximaReavaliacao)}</p>
                      <p className="mt-1 text-[11px] text-slate-600">Cronograma de homologação</p>
                    </div>
                  </div>
                </section>
              </div>
